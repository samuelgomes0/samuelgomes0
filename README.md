...
event-driven systems — primarily in **TypeScript** and **Python**.
...
- 🔬 **Front-End Tech Lead** at iTec/FURG-Embrapii — AI multi-agent platform (CoAutoria)
- 🧠 Specializing in **Go**, **Design System** and **Artificial Intelligence**
